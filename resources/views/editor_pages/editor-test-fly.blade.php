...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/assets/editor/stylesheets/toastr.min.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/grapes.min.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/grapesjs-preset-webpage.min.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/tooltip.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/grapesjs-plugin-filestack.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/demos.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">
    <link rel="stylesheet" href="/assets/editor/stylesheets/custom-toast.css"/>
    ...
    <script src="/assets/editor/js/toastr.min.js"></script>

    <script src="/assets/editor/js/grapes.min.js"></script>
    <script src="/assets/editor/js/grapesjs-preset-webpage.min.js"></script>
    <script src="/assets/editor/js/grapesjs-lory-slider.min.js"></script>
    <script src="/assets/editor/js/grapesjs-tabs.min.js"></script>
    <script src="/assets/editor/js/grapesjs-custom-code.min.js"></script>
    <script src="/assets/editor/js/grapesjs-touch.min.js"></script>
    <script src="/assets/editor/js/grapesjs-parser-postcss.min.js"></script>
    <script src="/assets/editor/js/grapesjs-tooltip.min.js"></script>
    <script src="/assets/editor/js/grapesjs-tui-image-editor.min.js"></script>
    <script src="/assets/editor/js/grapesjs-typed.min.js"></script>

    <script src="/assets/editor/js/custom-declarations.js"></script>
    ...
    <style type="text/css">
        ...
        .icon-option-change-device {
            font-size: 3.5rem;
            color: #007bff;
        }

        .text-menu-option-change-device {
            font-size: 0.4rem;
            color: #007bff;
            font-weight: bold;
        }
  ...
  <body>
    <div style="display: none">
      <div class="gjs-logo-cont">
        <a href="//grapesjs.com"><img class="gjs-logo" src="/assets/editor/img/grapesjs-logo-cl.png"></a>
    ...
    <div class="ad-cont">
      ...
      <script async type="text/javascript" src="./assets/editor/js/carbon.js"></script>
    </div>
    ...
    <div id="gjs" style="height:0px; overflow:hidden">
      ...
      <style>
        ...
        .header-banner{
          ...
          font-weight: 100;
          background-image:url("/assets/editor/img/bg-gr-v.png"), url("/assets/editor/img/work-desk.jpg");
    ...
    <div class="change-device-container">
        <button id="toggle-extra-options" class="toggle-options noselect"><i class="fa fa-compass" aria-hidden="true"></i></button>
        <div id="options-container" style="display:none;">
          <button class="top-web-device noselect"><i class="fa fa-arrow-left icon-option-change-device" aria-hidden="true"></i><br/><span class="text-menu-option-change-device">BACK</span></button>
          <br/>
          <button class="down-mobile-device noselect"><i class="fa fa-cloud icon-option-change-device" aria-hidden="true"></i><br/><span class="text-menu-option-change-device">SAVE</span></button>
        </div>
    </div>
    ...
    <script src="/assets/editor/js/custom-editor-functions.js" async defer></script>
    <script src="/assets/editor/js/custom-editor-actions.js" async defer></script>
  </body>
</html>
